...
" He cambiado #242424 por #282828

" General colors
hi Normal ctermfg=252 ctermbg=234 cterm=none guifg=#e3e0d7 guibg=#282828 gui=none
hi Cursor ctermfg=234 ctermbg=228 cterm=none guifg=#282828 guibg=#eae788 gui=none
...
" Hacer poner los números más oscuros y cambiar fondo de SignColumn
" hi LineNr ctermfg=241 ctermbg=232 cterm=none guifg=#857b6f guibg=#080808 gui=none
hi SignColumn	ctermfg=243		ctermbg=0		cterm=none		guifg=#857b6f	guibg=#282828	gui=none
hi LineNr		ctermfg=243		ctermbg=0		cterm=none		guifg=#5e574d	guibg=#282828	gui=none
...
hi DiffDelete ctermfg=234 ctermbg=60 cterm=none guifg=#282828 guibg=#3e3969 gui=none
...
" hi ColorColumn guibg=#262626 ctermbg=235n
hi ColorColumn ctermbg=53 cterm=none guibg=#73186e gui=none
